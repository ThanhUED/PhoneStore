          ...
          <h2 class="page-header">
            <div style="display: inline-flex; align-items: center;">
              <div style="width: 30px; margin-right: 5px;">
                <!-- <img src="{{ asset('images/favicon.png') }}" alt="TStore Logo" style="width: 100%; height: auto; object-fit: cover;"> -->
              </div>
              <div style="color: #f33;">TStore</div>
            </div>
      ...
      <div class="invoice-info">
        <div class="row">
          <div class="col-md-3 col-sm-3 col-xs-3">
            ...
            <address>
              <b>Admin TStore</b><br>
              Phone: (+84) 906 440 606<br>
              Email: tstore@gmail.com<br>
              Address: Đại học Sư phạm Đà Nẵng.
            </address>
          </div>
          <div class="col-md-3 col-sm-3 col-xs-3">
            To: <br>
