              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-4 col-sm-4 col-xs-4">
                    ...
                    <!-- /.chart-responsive -->
                    <p class="text-center">
                      <i>Hình 1: Thị phần sản phẩm bán được theo nhà sản xuất</i>
                    </p>
                  </div>
                  <!-- /.col -->
                  <div class="col-md-4 col-sm-4 col-xs-4">
                    ...
                    <!-- /.chart-responsive -->
                    <p class="text-center">
                      <i>Hình 2: Thị phần doanh thu theo nhà sản xuất</i>
                    </p>
                  </div>
                  <!-- /.col -->
                  <div class="col-md-4 col-sm-4 col-xs-4">
                    ...
                    <!-- /.chart-responsive -->
                    <p class="text-center">
                      <i>Hình 3: Thị phần lợi nhuận theo nhà sản xuất</i>
                    </p>
                  </div>
                  <!-- /.col -->
                </div>
  ...
  $(document).ready(function() {
    $('.btn-print').click(function(){
      printJS({
        ...
        type: 'html',
        documentTitle: ' ',
        header: 'Báo Cáo Tình Hình Kinh Doanh Website TStore',
