      ...
      <div class="row">
        <div class="col-md-3 col-sm-4 col-xs-6 col-ssm">
          <div class="footer-widget">
            ...
            <div class="widget-content">
              <p><b><i class="fas fa-mobile-alt"></i> Hotline:</b> <a href="tel:(+84) 906 440 606">(+84) 906 440 606</a></p>
              <p><b><i class="fas fa-envelope"></i> Email:</b> <a href="mailto:tstore@gmail.com" rel="nofollow">tstore@gmail.com</a></p>
        ...
        <div class="col-md-3 col-sm-4 hidden-xs">
          <div class="footer-widget">
            ...
            <div class="widget-content">
              <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fkhoatinhoc%2F&tabs=timeline&width=340&height=250&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=2449518365367012" width="270" height="130" style="border: none; overflow: hidden; max-width: 100%;" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
            </div>
          </div>
        </div>
      </div>
