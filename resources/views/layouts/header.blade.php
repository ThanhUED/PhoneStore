  ...
  <div class="mobile-main-menu-bottom">
    <div class="mobile-support">
      ...
      <div class="info-support">
        <i class="fa fa-phone" aria-hidden="true"></i> HOTLINE: <a href="tel: +84 906 440 606" title="(+84) 906 440 606">(+84) 906 440 606</a>
      </div>
      <div class="info-support">
        <i class="fa fa-envelope" aria-hidden="true"></i> EMAIL: <a href="mailto:tstore@gmail.com" title="tstore@gmail.com">tstore@gmail.com</a>
      </div>
    </div>
  </div>
</div>
